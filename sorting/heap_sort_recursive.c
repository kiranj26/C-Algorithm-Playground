/**
 * @file heap_sort_recursive.c
 * @brief Provides functions to sort an array using the Heap Sort algorithm (recursive version).
 * 
...
/**
 * @brief Perform heap sort on an array using a recursive approach.
 * 
